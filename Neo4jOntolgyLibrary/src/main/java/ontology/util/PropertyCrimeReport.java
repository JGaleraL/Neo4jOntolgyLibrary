...
//                    setProbabilityElementAndFactor (stolenByOwner, 5, getFactor(r) * 1.0/stolenByOwner.size());
            ...
            case "Article240_1" :
                ...
                setProbabilityElementAndFactor (someHasOffenceCharacteristic_1, 3, 1.0/someHasOffenceCharacteristic_1.size());
            ...
            case "Article241" :
                ...
                setProbabilityElementAndFactor (someHasOffenceCharacteristic_2, 3, 1.0/someHasOffenceCharacteristic_2.size());
            ...
            case "Article242_1" :
                ...
                setProbabilityElementAndFactor (someHasOffenceCharacteristic_3, 3, 1.0/someHasOffenceCharacteristic_3.size());
...
//                                                                     relation, 7);
                ...
                if (!someExistsOffenceAggravatingFactor.isEmpty()) {
                    setProbabilityElementAndFactor (someExistsOffenceAggravatingFactor, 6, 1.0/someExistsOffenceAggravatingFactor.size());
...
//                relation.addAll(article_241_4_clause);
            ...
            case "Article242_2" :
                ...
                setProbabilityElementAndFactor (someHasOffenceCharacteristic1, 3, 1.0/someHasOffenceCharacteristic1.size());
