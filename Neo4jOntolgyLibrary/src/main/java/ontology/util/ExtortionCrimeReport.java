        ...
        public void defineArticlePriorProbability(Node n,
                ...
                switch (article) {
                        ...
                        case "ExtortionReport":
                                ...
                                for (Relationship r : actViolence) {
                                        this.setQualifiedRelationship(n, r, "ExtortionViolence");
                                }
                                ...
                                for (Relationship r : profitIntent) {
                                        this.setQualifiedRelationship(n, r, "ProfitIntent");
                                }
                                ...
                                for (Relationship r : ecoDamage) {
                                        this.setQualifiedRelationship(n, r, "EconomicDamage");
                                }
                                ...
                                for (Relationship r : actOmission) {
                                        ...
                                        LinkedHashSet<Relationship> extBy = checkSomeRelationTypeAndObject(
                                                        r.getEndNode(),
                                        ...
                                        LinkedHashSet<Relationship> extTo = checkSomeRelationTypeAndObject(
                                                        r.getEndNode(),
